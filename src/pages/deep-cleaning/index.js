...
function Deepcleaning() {
    ...
    return (
        <div className="container">
            ...
            <button type="button" className="btn btn-outline-danger" fdprocessedid="t7kb4"><Link to ="/deep-cleaning-sp" className="alink">Español </Link></button>
            </div>
            ...
            <div className="row">
                ...
                <ol>
                    ...
                    <li>
                        By signing this document, <b>I consent to the periodontal treatment </b>described above by the doctor, Cesar E. Zamora Perez D.D.S. I attest that I have discussed the risk, benefits, consequences, and alternatives to periodontal treatment with the doctor. I had the opportunity to ask questions, and I understand what has been explained.
                    </li>
                </ol>
